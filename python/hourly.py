...
def get_hours():
    ...
    outlook = json.load(open("/Users/avinasharavind/Documents/Weather_Projects/NWS_Forecast_Page/static/files/hourly.json"))
    ...
    griddata = json.load(open("/Users/avinasharavind/Documents/Weather_Projects/NWS_Forecast_Page/static/files/griddata.json"))
    feelsLike = []
